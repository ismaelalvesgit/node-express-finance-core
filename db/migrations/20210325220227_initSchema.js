...
exports.up = async function (knex) {
  ...
  await knex.schema.createTable("investment", (table) => {
    ...
    table.decimal("priceDayLow", 10, 7).defaultTo(0).nullable();
    table.decimal("changePercentDay").defaultTo(0).nullable();
    table.decimal("variationDay", 10, 7).defaultTo(0).nullable();
    table.decimal("changePercentTotal").defaultTo(0).nullable();
    table.decimal("variationTotal", 10, 7).defaultTo(0).nullable();
    table.bigInteger("volumeDay").defaultTo(0).nullable();
    table.decimal("previousClosePrice", 10, 7).defaultTo(0).nullable();
    createdAt(knex, table);
    updatedAt(knex, table);
  });
  ...
  await knex.schema.createTable("transaction", (table) => {
    ...
    table.decimal("brokerage", 10, 7).defaultTo(0).nullable();
